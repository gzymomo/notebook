- [实战！工作中常用到哪些设计模式](https://mp.weixin.qq.com/s/KDun2ku4Pvpo3hvOR8KW5Q)

平时我们写代码呢，多数情况都是**流水线式**写代码，基本就可以实现业务逻辑了。**如何在写代码中找到乐趣呢**，我觉得，最好的方式就是：**使用设计模式优化自己的业务代码**。今天跟大家聊聊日常工作中，我都使用过哪些设计模式。

![图片](https://mmbiz.qpic.cn/mmbiz_png/PoF8jo1PmpwnEoGbnjibl4txzyz5QMz2YbK74BrHJNZuF7Rj7peaDmKibiaiaaJ616ju3SPl4AS7hiboJdmJDcw59Hg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)工作中常用到哪些设计模式
