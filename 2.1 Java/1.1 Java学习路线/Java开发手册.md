...
![image-20220102225724783](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102225724783.png)

那么加上 Java 应用、JVM 的体系结构会变为如下

![image-20220102225734872](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102225734872.png)
...
![image-20220102225753091](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102225753091.png)
...
![image-20220102225834694](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102225834694.png)
...
![image-20220102225852080](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102225852080.png)
...
![image-20220102225907249](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102225907249.png)

- 逻辑运算符

逻辑运算符主要有三种，与、或、非

![image-20220102225918795](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102225918795.png)

下面是逻辑运算符对应的 true/false 符号表

![image-20220102225935854](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102225935854.png)

- 按位运算符

按位运算符用来操作整数基本类型中的每个`比特`位，也就是二进制位。按位操作符会对两个参数中对应的位执行布尔代数运算，并最终生成一个结果。

![image-20220102225945198](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102225945198.png)
...
![image-20220102225954758](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102225954758.png)
...
![image-20220102230613536](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102230613536.png)
...
![image-20220102230646270](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102230646270.png)
...
![image-20220102230738168](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102230738168.png)
...
![image-20220102230753828](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102230753828.png)
...
![image-20220102230805924](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102230805924.png)
...
![image-20220102230816607](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102230816607.png)
...
![image-20220102230827874](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102230827874.png)
...
![image-20220102230849067](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102230849067.png)
...
![image-20220102230924139](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102230924139.png)
...
![image-20220102230937081](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102230937081.png)

UncheckedException

![image-20220102230947985](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102230947985.png)

### 7.4 与 Exception 有关的 Java 关键字

那么 Java 中是如何处理这些异常的呢？在 Java 中有这几个关键字 **throws、throw、try、finally、catch** 下面我们分别来探讨一下

#### 7.4.1 throws 和 throw
...
![image-20220102231018745](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231018745.png)
...
![image-20220102231032656](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231032656.png)
...
![image-20220102231059790](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231059790.png)
...
#### 9.2.7 LinkedHashSet 类

LinkedHashSet 继承于 Set，先来看一下 LinkedHashSet 的继承体系：

![image-20220102231157324](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231157324.png)
...
![image-20220102231245707](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231245707.png)
...
![image-20220102231323086](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231323086.png)
...
![image-20220102231350570](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231350570.png)
...
![image-20220102231413019](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231413019.png)

![image-20220102231420476](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231420476.png)
...
![image-20220102231436798](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231436798.png)
...
![image-20220102231448462](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231448462.png)
...
![image-20220102231502626](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231502626.png)

I/O 还可以根据操作对象来进行区分：主要分为

![image-20220102231518470](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231518470.png)
...
![image-20220102231534377](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231534377.png)
...
![image-20220102231546393](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231546393.png)

#### 13.2.2 OutputStream

OutputStream 是定义了流式字节输出模式的抽象类。该类的所有方法返回一个void 值并且在出错情况下引发一个IOException异常。它的主要方法定义如下

![image-20220102231559321](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231559321.png)

#### 13.2.3 Reader 类

Reader 是 Java 定义的流式字符输入模式的抽象类。类中的方法在出错时引发 `IOException` 异常。

![image-20220102231611173](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231611173.png)

#### 13.2.4 Writer 类

Writer 是定义流式字符输出的抽象类。 所有该类的方法都返回一个 void 值并在出错条件下引发 IOException 异常

![image-20220102231627166](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231627166.png)

### 13.3 InputStream 及其子类
...
![image-20220102231658072](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231658072.png)

### 15.1 大小写敏感

首先，null 是 Java 中的`关键字`，像是 **public、static、final。**它是大小写敏感的，你不能将 null 写成 Null 或 NULL，编辑器将不能识别它们然后报错。

![image-20220102231709280](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231709280.png)

这个问题已经几乎不会出现，因为 eclipse 和 Idea 编译器已经给出了编译器提示，所以你不用考虑这个问题。

### 15.2 null 是任何引用类型的初始值
...
![image-20220102231721725](https://gitee.com/er-huomeng/img/raw/master/img/image-20220102231721725.png)
